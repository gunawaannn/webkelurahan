...
class Potensi extends CI_Controller{
	...
	function pekerjaan(){
		...
		$jenis = array('petani'=>0, 'nelayan'=>0, 'pns'=>0, 'wiraswasta'=>0, 'pelajar'=>0, 'swasta'=>0, 'rumah'=>0, 'lain'=>0);
		...
		$data['pekerjaan'] = $jenis['petani'].','.$jenis['nelayan'].','.$jenis['pns'].','.$jenis['wiraswasta'].','.$jenis['pelajar'].','.$jenis['swasta'].','.$jenis['rumah'].','.$jenis['lain'];
	...
	function detail(){
		$title['judul'] = 'Data Potensi Kelurahan';
