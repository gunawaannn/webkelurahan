...
class Kegiatan extends CI_Controller{
	...
	function cetak_rab($id){
		...
		$data['element'] .= "<h4 style='margin-top:-8px;' class='text-center'>KELURAHAN SIWA KECAMATAN PITUMPANUA</h4>";
		...
		$data['element'] .= '</table>';
		$data['element'] .= '<br><br>';
		$data['element'] .= '<div class="pull-right text-center" style="width: 100%;"><h5>Siwa, '.date("d M Y").'</h5></div>';
		...
		$data['element'] .= '<h5 for="" style="margin-top:-8px;">Lurah Siwa</h5><br/><br><br><br>';
		$data['element'] .= '<h5><strong>Basri, S.Sos</strong></h5>';
		$data['element'] .= '</div>';
	...
	function cetak_lpj($id){
		...
		$data['element'] .= '<h5>Yth. Lurah Siwa <strong>Khoirul Anam</strong></h5>';
		$data['element'] .= '<h5>melalui Sekretaris Lurah</h5>';
		...
		$data['element'] .= '<h5 for="">Siwa, '.date("d M Y").'</h5>';
