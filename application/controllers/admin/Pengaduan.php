...
class Pengaduan extends CI_Controller{
	...
	function cetak($id){
		...
		$data['element'] .= "<h4 style='margin-top:-8px;' class='text-center'>KELURAHAN SIWA KABUPATEN WAJO</h4>";
		$data['element'] .= "</div>";
		...
		$data['element'] .= '<tr>';
		$data['element'] .= '<td width="10" style="border:none;"></td>';
		$data['element'] .= '<th scope="row" width="120" style="border:none;">Telp</th>';
		$data['element'] .= '<td width="10" style="border:none;">:</td>';
		$data['element'] .= '<td class="garisbawah" style="border-top:none; border-bottom: 1px solid black;">'.$hasil->no_telp.'</td>';
		$data['element'] .= '</tr>';
		$data['element'] .= '<tr>';
		$data['element'] .= '<td width="10" style="border:none;"></td>';
		...
		$data['element'] .= '<h5 for="">Siwa, '.date("d M Y", strtotime($hasil->tgl_pengaduan)).'</h5>';
