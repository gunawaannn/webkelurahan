...
class Surat extends CI_Controller{
	...
	function cetak($surat, $nik, $id){
		...
		$data['element'] .= "<h4 class='text-center'><strong>PEMERINTAH KABUPATEN WAJO</strong></h4>";
		$data['element'] .= "<h4 style='margin-top:-8px;' class='text-center'><strong>KECAMATAN PITUMPANUA</strong></h4>";
		$data['element'] .= "<h4 style='font-size:20px; margin-top:-8px; font-weight:bold;' class='text-center'>KELURAHAN SIWA</h4>";
		$data['element'] .= "<h5 style='margin-top:-8px;' class='text-center'>JL. Sultan Alauddin No.  Siwa Kode Pos 90992</h5>";
		$data['element'] .= "</div>";
		$data['element'] .= "<div style='padding-bottom:20px; width:3cm; margin-right:20px;' class='pull-right'>";
		$data['element'] .= "<img src='".base_url("assets/img/favicon.png")."' style='width:2.5cm;'>";
		...
		$data['element'] .= "<p>Saya yang bertanda di bawah ini selaku Lurah Siwa, dengan ini menerangkan bahwa:</p>";
		...
		if ($surat=='kelahiran') {
			...
			$data['element'] .= '<td style="border:none;">: Kelurahan Siwa,'.$hasil->alamat.', Lingkungan '.$hasil->lingkungan.'</td>';
			$data['element'] .= '</tr>';
			$data['element'] .= '</tbody>';
			$data['element'] .= '</table>';
		} elseif ($surat=='kematian') {
			...
			$data['element'] .= '</tbody>';
			$data['element'] .= '</table>';
			$data['element'] .= "<p>Yang bersangkutan benar-benar warga Kelurahan Siwa yang tidak mampu untuk melakukan pembayaran $hasil->tujuan.</p><br/>";
		} elseif ($surat=='biodata') {
			...
			$data['element'] .= '</tbody>';
			$data['element'] .= '</table>';
			$data['element'] .= "<p>Yang bersangkutan benar-benar warga Kelurahan Siwa yang memiliki anggota keluarga sebagai berikut:.</p><br/>";
			$data['element'] .= '<table class="table table-borderless">';
			$data['element'] .= '<tbody>';
			$data['element'] .= "
			<tr>
