  ...
  <header id="header" class="header header-hide">
    <div class="container">
      <div id="logo" class="pull-left">
        <h1><a href="<?=base_url()?>" class="scrollto"><span>KELURAHAN</span> SIWA</a></h1>
      </div>
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          <li class="menu-has-children"><a href="#">Data Kelurahan</a>
            <ul>
              <li><a href="<?=base_url()?>potensi/profil">Profil Kelurahan</a></li>
              ...
              <li><a href="<?=base_url()?>potensi/detail">Detail</a></li>
            </ul>
          </li>
