...
<section id="get-started" class="padd-section text-center wow fadeInUp">
  <div class="container">
    <div class="section-title text-center">
      ...
      <p class="separator" style="">Berikut data pekerjaan warga Kelurahan Siwa.</p>
    </div>
    <div class="row">
...
new Chart(document.getElementById("bar-chart"), {
  type: 'bar',
  data: {
    labels: ["Petani/Peternak", "Nelayan", "PNS", "Wiraswasta","Pelajar/Mahasiswa","Karyawan Swasta","Mengurus Rumah tangga","Lainnya"],
    datasets: [
      {
        // label: "Population (millions)",
        backgroundColor: ["#3e95cd", "#8e5ea2","#3cba9f","#e8c3b9","#c45850","#3c2a40","#3e95cd","#ce2850"],
        data: [<?=$pekerjaan?>]
