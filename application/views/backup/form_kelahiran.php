  ...
  <div class="tab-content" id="pills-tabContent">
    ...
    <div class="tab-pane fade show active" id="pills-satu" role="tabpanel" aria-labelledby="pills-satu-tab">
      <div class="form-row col-md-12">
        ...
        <div class="form-group col-md-2">
          <label for="" class="control-label">Kelurahan <span class="text-danger">*</span> </label>
          <select class="form-control" name="dusun">
            <option value="pager">Siwa</option>
            <option value="ngumbuk">Tocamming</option>
            <option value="bendet">Mattugengkeng</option>
          </select>
        </div>
    ...
    <div class="tab-pane fade" id="pills-dua" role="tabpanel" aria-labelledby="pills-dua-tab">
      <div class="form-row col-md-12">
        ...
        <div class="form-group col-md-2">
          <label for="" class="control-label">Lingkungan <span class="text-danger">*</span> </label>
          <select class="form-control" name="dusun">
